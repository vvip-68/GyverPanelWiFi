...
### Фишки
 ...
 - ***Новое!*** Поддержка [составных матриц](https://github.com/vvip-68/GyverPanelWiFi/wiki/Сборная-матрица), собранных из стандартных матриц 8x8, 16x16, 8x32 в одну матрицу большого размера.
 - ***Новое!*** [Настройка](https://github.com/vvip-68/GyverPanelWiFi/wiki/Сборная-матрица) размеров матрицы (ширины и высоты), а также способ ее подключения - угол, направление из угла задаются в приложении-компаньоне
...
**Не используйте библиотеку поддержки плат ESP (ядро) версии 3.x.х - с ними проект работать не будет ввиду несовместимости с библиотекой FаstLED указанных версий**
