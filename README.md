...
### Фишки
 ...
 - ***Новое!*** Беспроводная трансляция эффектов на матрицу устройств из специализированных программ типа *Jinx!*, *Wixen Lights* и подобных по протоколу *sACN Streaming ACN E1.31 DMX*
