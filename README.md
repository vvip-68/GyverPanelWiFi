...
с расширением возможностей работы на неквадратных широких матрицах с размерами более 25x16.  
...
### Фишки
 - Более 30 крутых эффектов с поддержкой отображения часов или текста бегущей строки поверх эффектов
...
- **{Rdate#N}** оставшееся до события время  
                где date - дата события в формате ДД.ММ.ГГГГ  
...
- **12** - "Лава"
- **13** - "Плазма"
- **14** - "Радужные переливы"
- **15** - "Полосатые переливы"
- **16** - "Зебра"
- **17** - "Шумящий лес"
- **18** - "Морской прибой"
- **19** - "Смена цвета"
