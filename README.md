...
### Фишки
 ...
 - Два специальных режима времени - ЭРассветЭ и "Закат". Время рассвета и заката не текущий день берется с сервера погоды при получении текущих погодных условия и температуры  
