...
<a id="chapter-0"></a>
## Описание проекта
Внимание!!! Проект находится в начальной стадии разработки Не все заявленные возможности реализованы.  
...
### Фишки
 ...
 - Регулировка яркости эффектов относительно яркости часов или текста бегущей строки
