...
логического уровня наделжн открываются лишь при напряжении на затворе не ниже 5 вольт. Схемы управления питанием для P-канального MOSFET IRF4905 и N-анального MOSFET IRF3205 приведены ниже.  
