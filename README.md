...
**Не используйте библиотеку поддержки плат ESP (ядро) версии 3.0.х - с ними проект работать не будет ввиду несовместимости в библиотекой FаstLED указанных версий**
