...
Наиболее предпочтительным типом с точки зрения эффективности - Последовательная матрица с параллельным питанием.
...
Угол подключения задается параметром **CONNECTION_ANGeukf, который может принимать следующие значения:  
...
Все сегменты составной матрицы **должны иметь одинаковый размер и быть сориентированны однообразно** - иметь один и тот же угол подключения первого 
...
Желтые цифры показывают размещение сегментов матрицы, порядок следования сегментов в сборной матрицы - розовые стрелки.  

## Сборная матрица 3x2 из шести сегментов 8x8 - выриант 1
...
## Сборная матрица 3x2 из шести сегментов 8x8 - выриант 2
