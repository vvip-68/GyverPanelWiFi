...
// - прекращение вывода контрольной информации в DEBUG()
...
#define WAIT_PLAY_FILE_FINISHED 1  // 1 - переключаться на следующий эффект только когда весь файл полностью показан; 
