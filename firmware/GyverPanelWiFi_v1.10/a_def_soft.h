...
#define EFFECT_LIST F("Часы,Лампа,Снегопад,Кубик,Радуга,Пейнтбол,Огонь,The Matrix,Шарики,Звездопад,Конфетти," \
                      ...
                      "Палитра,Спектрум,Синусы,Вышиванка,Дождь,Камин,Водопад,Стрелки,Погода,Жизнь,Узоры,Рассвет,SD-Карта")
#else
#define EFFECT_LIST F("Часы,Лампа,Снегопад,Кубик,Радуга,Пейнтбол,Огонь,The Matrix,Шарики,Звездопад,Конфетти," \
                      "Цветной шум,Облака,Лава,Плазма,Радужные переливы,Павлин,Зебра,Шумящий лес,Морской прибой,Смена цвета," \
                      "Светлячки,Водоворот,Циклон,Мерцание,Северное сияние,Тени,Лабиринт,Змейка,Тетрис,Арканоид," \
                      "Палитра,Спектрум,Синусы,Вышиванка,Дождь,Камин,Водопад,Стрелки,Погода,Жизнь,Узоры,Рассвет")
#endif
...
#define    minDim                min(WIDTH, HEIGHT)
  ...
  #define    OVERLAY_SIZE          WIDTH * 21       // высотв шрифта 16 + 3 строки диакритич символов над знакоместом и две - под знакоместом
#else
  // Шрифт размером 8x13
  #define    OVERLAY_SIZE          WIDTH * 18       // высотв шрифта 13 + 3 строки диакритич символов над знакоместом и две - под знакоместом
#endif
