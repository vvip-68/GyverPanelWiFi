...
const animation_t animation_mario PROGMEM = {  
   ...
   .move_type = 1+16+64,                // Тип движения - битовый флаг (разрешено только при отрисовке кадра целиком, при построчном - не работает): 
                                        ...
                                        // 128 - переворот картинки при отражении по вртикали
   ...
   .background_effect = {               // Список эффектов, один из которых выбирается в качестве бэкграунда; Если -1 - не использовать
      MC_RAIN,                          // Дождь
      MC_SNOW,                          // Снегопад
      MC_FIRE,                          // Камин
      MC_FLICKER,                       // Мерцание
