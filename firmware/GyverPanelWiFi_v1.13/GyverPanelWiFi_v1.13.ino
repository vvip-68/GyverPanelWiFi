...
#define FIRMWARE_VER F("WiFiPanel v.1.13.2024.0901")
...
// https://aliexpress.ru/item/1005004499970609.html  ( ESP32-WROOM-32 )
...
// Версия FastLED      - 3.7.0  // 3.6 - смотри комментарий ниже в секции FastLED
// 
...
//
//   Обычно Arduino IDE v2.3.x определяет тип платы, подключенной к USB-порту самостоятельно и предлагает его для использования
//   Возможно он не ошибается - попробуйте использовать предложенный тип
//
...
// *** Arduino IDE
//
// Проект собирался и тестировался в двух версиях Arduino IDE - v1.8.19 и v2.3.2 
//
// -------------------------------------------------------------------------------------------------------
//
// *** FastLED
...
// Версии 3.6.x не проверялись. На последней на текущий момент версии 3.7.4 эффекты выводятся с подергиванием          
//
// -------------------------------------------------------------------------------------------------------
//
// *** MP3 DFPlayer
...
// - arduino-littlefs-upload-1.1.8.vsix - плагин для загрузки данных в файловую систему LittleFS для ESP8266/ESP32  ( https://github.com/earlephilhower/arduino-littlefs-upload       )
//
