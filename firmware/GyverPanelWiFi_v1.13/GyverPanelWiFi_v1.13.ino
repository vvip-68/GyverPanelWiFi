...
#define FIRMWARE_VER F("WiFiPanel v.1.13.2023.1223")
...
//
// Версия ядра ESP8266 - 2.7.4  || 3.1.2   
// Версия ядра ESP32   - 2.0.6  || 2.0.14
// Версия FastLED      - 3.5.0  || 3.6.0
// 
// Для версии ядра 2.7.4
...
//   Плату выбираем реально которую используете - для NodeMCU - "NodeMCU 1.0 (ESP12E Module)", для Wemod D11 mini - "LOLIN(WEMOS) D1 mini (clone)"
//   Пин вывода на ленту LED_PIN обозначен как D2 (GPIO4) - вывод идет на D2
//
...
//
// На версии ядра ESP8266 отличной от 2.7.4 и библиотеки FastLED 3.4/3.5 стабильная работа не гарантируется, за исключением комбинации ядро 3.1.2 + FastLED 3.6
// На версии ядра ESP32 отличной от 2.0.6 и библиотеки FastLED 3.4/3.5 или ядро 2.0.14 и FastLED 3.6 работать не будет!
