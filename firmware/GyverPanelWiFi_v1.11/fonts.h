...
// подстрочнык "хвостики" в буквах Д Ц Щ Ą ą Ę ę ų Į į Ų - вмещаются в знакоместо 
...
const uint16_t fontHEX[][10] PROGMEM = {
  ...
  {0x1FE0, 0x3FF0, 0x7338, 0x7318, 0x6318, 0x6318, 0x6318, 0x7018, 0x3870, 0x1860},  // є     162
  {0x0000, 0x0000, 0x0026, 0x6016, 0x7FF0, 0x7FF6, 0x6006, 0x0000, 0x0000, 0x0000},  // ї     163
};
...
const uint16_t fontHEX[][8] PROGMEM = {
  ...
  {0x0E07, 0x030C, 0x0198, 0x00F0, 0x00F0, 0x0198, 0x030C, 0x0E07},  // Х     116
  ...
  {0x03E0, 0x07F0, 0x0C98, 0x0C98, 0x0C98, 0x0C98, 0x0410, 0x0220},  // є     162
  {0x0000, 0x0006, 0x0C06, 0x0FF0, 0x0FF0, 0x0C06, 0x0006, 0x0000},  // ї     163
};
