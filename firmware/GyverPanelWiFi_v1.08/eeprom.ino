...
void saveDefaults() {
  ...
  textLines[23]  = "Сегодня 15 января 2021 года!{S15.01.2021}";  
  textLines[23]  = "Ура! Каникулы!!!{S01.01.****#14.01.**** 20:00}{S01.04.****#08.04.**** 20:00}";
  textLines[23]  = "Весь январь c 9:00 до 15:00 я вижу эту строку...{S**.01.**** 9:00#**.01.**** 15:00}";  
  textLines[23]  = "Каждое 6 и 12 число месяца c 9:00 до 15:00 я вижу эту строку...{S06.**.**** 9:00#06.**.**** 15:00}{S12.**.**** 9:00#12.**.**** 15:00}";  
  textLines[23]  = "";  
