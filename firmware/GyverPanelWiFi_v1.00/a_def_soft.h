...
int8_t   nextTextLine = -1;              // Какую следующую строку показыват, может быть указан макросом в строке. Если указан - интервал отображения игнорируется, строка показывается сразу;
...
String   currentText  = "";              // Текущая отображаемая строка
// --- 

boolean loadingTextFlag = false;         // Флаг штшциализации показа очередной строки
