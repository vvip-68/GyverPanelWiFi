...
int8_t CLOCK_WX;                            // Позиция вывода погоды по X
...
bool     mqtt_state_packet = false;              // Способ передачи состояния: true - в пакете, false - каждый параметр индивидуально
...
#define    OVERLAY_SIZE          WIDTH * 15      // 15 - макс высота области оверлея - для верт больших часов, календарь 11 или шрифт с диакрит. символами 13 - меньше 15
