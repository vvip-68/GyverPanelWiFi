...
// Внимание!!!
// Явное задание адреса, который получит устройство предполагает, что ваш роутер имеет в сети адрес, оканчивающийся на 1, 
// то есть для указанного тут по умолчанию адреса, адрес роутера будет 192.168.0.1
// Если роутер имеет другой адрес, не оканчивающийся на 1 - есть два варианта:
// 1. Укажите адрес по умолчанию ниже  {0, 0, 0, 0} - это включит режим DHCP - устройство будет получать сетевые настройки от роутера.
//    Полученный устройством автоматический адрес можно узнать, посмотрев в логе в мониторе порта или по 4-х-кратному нажатию кнопки.
// 2. В основном файле скетча в функции startWiFi() в строках 418 и 420 вместо '1' указать аоследнюю цифру IP адреса вашего роутера
