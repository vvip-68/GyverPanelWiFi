...
byte       sWIDTH = WIDTH;                       // ширина одного сегмента матрицы 1..127
byte       sHEIGHT = HEIGHT;                     // высота одного сегмента матрицы 1..127
...
byte       mWIDTH = META_MATRIX_WIDTH;           // количество сегментов в ширину 1..9
byte       mHEIGHT = META_MATRIX_HEIGHT;         // количество сегментов в высоту 1..9
