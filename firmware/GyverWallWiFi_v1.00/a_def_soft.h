...
#define MC_BALL                  2
#define MC_RAINBOW               3
#define MC_RAINBOW_DIAG          3  // после удалить
...
#define MC_RAINBOW_HORIZ        10  // после удалить (заменить на другой эффект)
#define MC_TEXT                 11  // после удалить (заменить на другой эффект)
...
#define MC_COLORS               21
#define MC_RAINBOW_VERT         22  // после удалить (заменить на другой эффект)
#define MC_LIGHTERS             23
#define MC_SWIRL                24
#define MC_CLOCK                25  // после удалить (заменить на другой эффект)
...
byte     effectBrightness = BRIGHTNESS;  // текущая яркость эффектов (чтобы выделить часы и бегущий текст эффекты могут иметь яркость меньше чем общая)
...
#define    TEXT_OVERLAY_SIZE   WIDTH * LET_HEIGHT            // размер оверлея под бегущую строку во всю ширину матрицы
#define    CLOCK_OVERLAY_SIZE  11 * 15                       // вертикальный календарь имеет размер 15x11

#if (TEXT_OVERLAY_SIZE > CLOCK_OVERLAY_SIZE)
#define    OVERLAY_SIZE  TEXT_OVERLAY_SIZE
#else
#define    OVERLAY_SIZE  CLOCK_OVERLAY_SIZE
#endif

CRGB       leds[NUM_LEDS];                                   // обращение к светодиодам матрицы через этот массив
CRGB       overlayLEDs[OVERLAY_SIZE];                        // буфер оверлея; по максимуму - для бегущей строки во всю ширину матрицы или отображение календаря малых часов - 15 ширина, 11 высота
